...
This checkout is the CenterPoint product on `codex/centerpoint`. Read WORKSPACE.md and docs/workspaces_ko.md before changing product scope or packaging.
...
- CenterPoint inference is required in this product.
