...
ConfigDocument ConfigProfileCodec::encode(const SystemConfig& config) {
  ...
  document.setBoolean("runtime.replay_processing_history", config.runtime.replay_processing_history);
...
bool ConfigProfileCodec::decode(const ConfigDocument& document, SystemConfig& config,
  ...
  readBool(document, "runtime.replay_processing_history", config.runtime.replay_processing_history, issues, source);
