...
2026-08-31 당시 소스를 대상으로 생성한 **과거 함수 색인**입니다. 현재 동작 설명은 [실행 흐름 안내](../../design/runtime_contract_v2.md), 현재 파일 위치는 [소스 설명서](../../source/source_guide_ko.md)를 먼저 확인하세요.
...
```powershell
python docs/archive/source_reference_2026-08-31/tools/generate_source_reference.py
```
...
```powershell
python docs/archive/source_reference_2026-08-31/tools/audit_docx_structure.py `
  docs/archive/source_reference_2026-08-31 `
...
```powershell
python docs/archive/source_reference_2026-08-31/tools/verify_source_reference.py `
