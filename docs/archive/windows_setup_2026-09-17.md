> 이 문서는 2026-09-17 GitHub 버전을 재현하는 과거 매뉴얼입니다. 2026-09-22 분리된 세 프로젝트의 현재 절차는 [작업 공간 안내](../guides/workspaces_ko.md)를 사용하세요.
...
첫 수집은 EDFA `none`, MCU disabled로 확인한 뒤 [실장비 검증 절차](../hardware/hardware_acceptance.md)를 따른다.
...
MCU 설정 적용 후 파형을 업로드하고 START한다. EDFA 출력 시험은 [실장비 검증 문서](../hardware/hardware_acceptance.md)의 순서를 따른다.
...
프로젝트 내부 참고: [빌드 설정](build_setup.md), [설정 형식](../design/configuration.md), [장비 검증](../hardware/hardware_acceptance.md), [장치 프로토콜](../hardware/device_protocols.md).
